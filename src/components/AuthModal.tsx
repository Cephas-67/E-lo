  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-4">
      <div className="auth-slide-container w-full max-w-4xl h-[650px] flex overflow-hidden">
        ...
        {/* Form Section */}
        <div className={`w-1/2 p-8 flex flex-col transition-transform duration-500 ${
          isLogin ? 'translate-x-0' : '-translate-x-full'
        }`}>
          <div className="w-full max-w-sm mx-auto h-full flex flex-col">
            ...
            <div className="flex justify-between items-center mb-6">
              ...
              <Button
                variant="ghost"
                onClick={onClose}
                className="text-gray-500 hover:text-gray-700 p-2 rounded-full hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors"
              >
                ✕
              </Button>
            </div>
            ...
            {/* Content container with scrolling if needed */}
